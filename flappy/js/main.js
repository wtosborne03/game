...
var myGameArea = {
    ...
    start : function() {
        ...
        this.context.scale(1920/window.innerWidth,1920/window.innerWidth );
        ...
        window.addEventListener('keydown', function (e) {
            ...
            myGamePiece.image.src = "flappy/img/bird1.png";
            jump();
            accelerate(0.05);
        })
...
function component(width, height, color, x, y, type) {
    ...
    this.update = function(){
        ...
        if(type == 'text'){
            ...
            ctx.drawImage(this.image, this.x + this.width*7, this.y, this.width, this.height);
            ctx.drawImage(this.image, this.x + this.width*8, this.y, this.width, this.height);
            ctx.drawImage(this.image, this.x + this.width*9, this.y, this.width, this.height);
...
function updateGameArea() {
    ...
    if (myGameArea.frameNo == 2 || everyinterval(300)) {
        ...
        myObstacles.push(new component(60, height, "flappy/img/pp.png", x, 0, "image"));
        myObstacles.push(new component(70, 25, "flappy/img/head.png", x-5, height, "image"));
        myObstacles.push(new component(70, 25, "flappy/img/head.png", x-5, height + gap, "image"));
        myObstacles.push(new component(60, y - height - gap - 150 -25, "flappy/img/pp.png", x, height + gap +25,"image")); 
    }           
    for (i = 0; i < myObstacles.length; i += 1) {
        myObstacles[i].x += -1;
